                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                ...
                                <div class="quantity">
                                    <router-link to="/cart" class="primary-btn pd-cart">Add To Carts</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
